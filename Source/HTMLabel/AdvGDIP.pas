...
\**************************************************************************)
  ...
  TGPImageAttributes = class(TSGdiplusBase)
  protected
...
//--------------------------------------------------------------------------
  ...
  TGPFontFamily = class(TSGdiplusBase)
  protected
...
//--------------------------------------------------------------------------
  ...
  TGPFontCollection = class(TSGdiplusBase)
  protected
...
\**************************************************************************)
  ...
  TGPStringFormat = class(TSGdiplusBase)
  protected
...
\**************************************************************************)
  ...
  TGPGraphicsPath = class(TSGdiplusBase)
  protected
    nativePath: GpPath;
    lastResult: TStatus;
...
\**************************************************************************)
  ...
  TGPGraphics = class(TSGdiplusBase)
  protected
...
class function TSGdiplusBase.NewInstance: TObject;
var
  p  : pointer;
  sz : ULONG;
begin
...
procedure TSGdiplusBase.FreeInstance;
begin
  CleanupInstance;
  GdipFree(Self);
end;
